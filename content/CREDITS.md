...
Đã có màn **Giới thiệu & nguồn dữ liệu** (Cài đặt → Giới thiệu & nguồn dữ liệu) hiển thị
ghi công + ràng buộc CC-BY-SA 4.0 của `meaning_vi` — đáp ứng yêu cầu attribution (E1-11).
...
Công cụ hỗ trợ rà: `tools/validate-content.js` (báo cáo [../docs/content-review.md](../docs/content-review.md))
và `tools/clean-meanings.js` (đã dọn rác Hán/`[pinyin]` khỏi `meaning_vi`).
